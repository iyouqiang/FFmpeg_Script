...
do
    ...
    TMPDIR=${TMPDIR/%\/} $currentdir/$source/configure \
        ...
        #此处路径需要替换
        --extra-cflags="-I/Users/Yohann/Desktop/Git项目/Yochi_FFmpeg/FFmpeg_Encodelibrary/iOS/thin-x264/arm64/include" \
        --extra-ldflags="-L//Users/Yohann/Desktop/Git项目/Yochi_FFmpeg/FFmpeg_Encodelibrary/iOS/thin-x264/arm64/lib" \
